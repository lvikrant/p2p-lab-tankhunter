...
public class GameWindow extends JFrame implements InformationVisualisation, ActionListener{
    ...
    public JLabel killsRedLabel;
    public JLabel killsGreenLabel;
    ...
    private JMenuBar getMenuBar0() {
        if (menuBar == null) {
            ...
            killsRedLabel = new JLabel("RED : 0  ");
            killsRedLabel.setForeground(Color.RED);
            killsRedLabel.setFont(new Font("Serif", Font.BOLD, 16));
            killsGreenLabel = new JLabel();
            killsGreenLabel.setFont(new Font("Serif", Font.BOLD, 16));
    		...
    		switch(GAMEMODE){
    		case 0 :  
   			 killsGreenLabel.setText("Kills : 0" + space);
             killsGreenLabel.setForeground(Color.RED);
...
public void movePanels(int angle){
	switch (angle) {
	case 0:
   	   gp00.setLocation((int)gp00.getLocation().getX()-2,(int)gp00.getLocation().getY());
   	   gp01.setLocation((int)gp01.getLocation().getX()-2,(int)gp01.getLocation().getY());
   	   gp02.setLocation((int)gp02.getLocation().getX()-2,(int)gp02.getLocation().getY());
   	   gp10.setLocation((int)gp10.getLocation().getX()-2,(int)gp10.getLocation().getY());
   	   gp.setLocation((int)gp.getLocation().getX()-2,(int)gp.getLocation().getY());
   	   gp12.setLocation((int)gp12.getLocation().getX()-2,(int)gp12.getLocation().getY());
   	   gp20.setLocation((int)gp20.getLocation().getX()-2,(int)gp20.getLocation().getY());
   	   gp21.setLocation((int)gp21.getLocation().getX()-2,(int)gp21.getLocation().getY());
   	   gp22.setLocation((int)gp22.getLocation().getX()-2,(int)gp22.getLocation().getY());
    	break;
	case 90:
		gp00.setLocation((int)gp00.getLocation().getX(),(int)gp00.getLocation().getY()+2);
		gp01.setLocation((int)gp01.getLocation().getX(),(int)gp01.getLocation().getY()+2);
		gp02.setLocation((int)gp02.getLocation().getX(),(int)gp02.getLocation().getY()+2);
		gp10.setLocation((int)gp10.getLocation().getX(),(int)gp10.getLocation().getY()+2);
 	    gp.setLocation(  (int)  gp.getLocation().getX(),(int)  gp.getLocation().getY()+2);
		gp12.setLocation((int)gp12.getLocation().getX(),(int)gp12.getLocation().getY()+2);
		gp20.setLocation((int)gp20.getLocation().getX(),(int)gp20.getLocation().getY()+2);
		gp21.setLocation((int)gp21.getLocation().getX(),(int)gp21.getLocation().getY()+2);
		gp22.setLocation((int)gp22.getLocation().getX(),(int)gp22.getLocation().getY()+2);	  
